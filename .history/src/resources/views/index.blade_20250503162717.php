                        ...
                        <form action="/confirm" method="post">
                            ...
                            <div class="contact-form__item-name">
                                <tr>
                                    ...
                                    <td><input type="text" name="last_name" placeholder="例:山田">
                                    <input type="text" name="first_name" placeholder="例:太郎"></td>
                                </tr>
                            </div>
                            ...
                            <div class="contact-form__item-select">
                                <tr>
                                    <th>お問い合わせの種類<span style="color: red;">※</span></th>
                                    <td>
                            ...
                            <div class="contact-form__item-inquiry">
                                <tr>
                                    <td>お問合せ内容<span style="color: red;">※</span></td>
                                    <td>
