                        ...
                        <form action="/admin" method="post">
                            ...
                            <div class="contact-form__item-tel">
                                ...
                                <select>
                                    ...
                                    <option name="delivery" value="">商品の交換について</option>
                                    <option name="delivery" value="">商品トラブル</option>
                                    <option name="delivery" value="">ショップへのお問合せ</option>
                                    <option name="delivery" value="">その他</option>
                                </select>
                            </div>
                            <div class="contact-form__item-tel">
                                <p>お問合せ内容</p>
