                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="category_id">
                                            ...
                                            <option  value="3" {{ old('category_id') == '1' ? 'selected' : '' }}>商品トラブル</option>
                                            <option  value="4" {{ old('category_id') == '1' ? 'selected' : '' }}>ショップへのお問合せ</option>
                                            <option  value="5" {{ old('category_id') == '1' ? 'selected' : '' }}>その他</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
