                        ...
                        <form action="/confirm" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="select">
                                            ...
                                            <option name="category_id" value="">商品のお届けについて</option>
                                            <option name="category_id" value="">商品の交換について</option>
                                            <option name="category_id" value="">商品トラブル</option>
                                            <option name="category_id" value="">ショップへのお問合せ</option>
                                            <option name="category_id" value="">その他</option>
                                        </select>
                                    </td>
                                </tr>
                            </div>
                            <div class="contact-form__item-inquiry">
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="deta" cols="50" rows="10"></textarea>
                                    </td>
                                </tr>
                            </div>
                            </table>
