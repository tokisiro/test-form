                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="category_id">
                                            ...
                                            <option  id="1" value="">商品のお届けについて</option>
                                            <option  id="2" value="">商品の交換について</option>
                                            <option  id="3" value="">商品トラブル</option>
                                            <option  id="4" value="">ショップへのお問合せ</option>
                                            <option  id="5" value="">その他</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
