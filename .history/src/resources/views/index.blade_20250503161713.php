                        ...
                        <form action="/confirm" method="post">
                            ...
                            <div class="contact-form__item-tel">
                                <tr>
                                    ...
                                    <td><input type="tel" name="tel1" maxlength="3" size="3"><p>-</p></td>
                                
                                <td><input type="tel" name="tel2" maxlength="4" size="4"><p>-</p></td>

                                <td><input type="tel" name="tel3" maxlength="4" size="4"></td>
                                </tr>
                            </div>
                            @if ($errors->has('tel'))
                                <tr>
